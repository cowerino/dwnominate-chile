# Status narratives, preserved from the README

The root README was reorganized on 2026-08-27 around the 55th-PL dynamic study. The
dated status sections it used to carry are preserved here verbatim; each describes
the repository as of its own date, superseded where the current README says so.
